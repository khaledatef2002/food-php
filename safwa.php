...
<body>
  ...
  <div class="offers col-lg-8 col-12 mx-auto">
    <?php
    $time = time();
    ...
    ?>
      ...
      <div class="col-lg-10 col-12 mx-auto">
        <div class="item-container col-lg-4 col-md-4 col-sm-6 col-6" style="padding: 0 5px;">
          <div class="card item show_safwa_card_det col-12" data-id="<?php echo $cards_item['id']; ?>">
            <div class="card-header text-center d-flex justify-content-center align-items-center">
              <h2 class="fs-5 my-1"><?php echo $cards_item['title']; ?></h2>
            </div>
            ...
            <div class="card-footer">
              <span class="fs-5" style="font-weight: bold;font-size: 1.6rem;display:block;text-align:center;"><?php echo __('show_details'); ?></span>
            </div>
          </div>
        </div>
      ...
      <div class="modal-content">
        <div class="modal-header" style="background: var(--icon-back-color);display:flex;justify-content:center;">
          <h2 style="color: #fff;text-align:center;margin:0;display:flex;justify-content:space-between;align-items:center;width:100%;font-size:2.3rem;">
            ...
            <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close" style="opacity:0.7;"><span aria-hidden="true" style="color: #fff;font-size:2.3rem;;font-weight: bold;margin:0">&times;</span></button>
          </h2>
        </div>
